...
// Get default language based on VITE_COUNTRY environment variable
const getDefaultLanguage = () => {
  const country = import.meta.env.VITE_COUNTRY || "GERMANY";
  return countryToLanguageMap[country] || "de";
};

// Function to get current language from localStorage or default based on country
export const getCurrentLanguage = () => {
  // const storedLanguage = localStorage.getItem("app_language");

  // If no language is stored, set and return the default language based on country
  // if (!storedLanguage) {
