...
// const CheckoutPage = () => {
//   // const { cartItems, clearCart,cartTotal,isInitialized } = useCart();
//   const { user } = useAuth();
...
//   // Create a unique key for each cart item based on product + variant + toppings
...
//       guest_shipping_address: isGuestLogin ? guest_shipping_address : null,
//       items,
//       payment: {
...
//     try {
//       let resp;
//       if (isGuestLogin && isGuestLogin === "true") {
...
//                   {/* Show each cart item individually (not grouped) */}
//                   {cartItems.map((item) => {
//                     const toppingsTotal =
//                       item.extras?.reduce(
//                         (sum, t) => sum + (t.price || 0) * (t.quantity || 1),
...
//                           <h4>
//                             {currentCurrency.symbol}
//                             {totalPrice.toLocaleString(currentCurrency.locale, {
//                               minimumFractionDigits: 2,
//                             })}
//                           </h4>
//                         </div>
...
//                       <span>
//                         {currentCurrency.symbol}{" "}
//                         {subtotal.toLocaleString(currentCurrency.locale, {
//                           minimumFractionDigits: 2,
//                         })}
//                       </span>
//                     </li>
...
//                       <span>
//                         {currentCurrency.symbol}{" "}
//                         {grandTotal.toLocaleString(currentCurrency.locale, {
//                           minimumFractionDigits: 2,
//                         })}
//                       </span>
//                     </li>
...
//           }}
//         >
//           {/* Mobile Totals Section - Same design as desktop */}
//           <div
...
//                   <span>
//                     {currentCurrency.symbol}{" "}
//                     {discountAmount.toLocaleString(currentCurrency.locale, {
//                       minimumFractionDigits: 2,
//                       maximumFractionDigits: 2,
//                     })}
//                   </span>
